  ...
  return (
    <div className="contact-section">
      <div className="contact-grid">
        {/* LinkedIn */}
        <a href="https://www.linkedin.com/in/echang0970" className="contact-item" target="_blank" rel="noopener noreferrer" title="LinkedIn">
        ...
        {/* GitHub */}
        <a href="https://github.com/ch4ngs4n1ty" className="contact-item" target="_blank" rel="noopener noreferrer" title="GitHub">
          <svg className="contact-logo" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Email */}
        <a href="mailto:echang0970@gmail.com" className="contact-item" title="Email">
          <svg className="contact-logo" viewBox="0 0 24 24" fill="currentColor">
