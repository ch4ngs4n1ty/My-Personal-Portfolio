...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailto = `mailto:echang0970@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
        ...
        <div>
          ...
          <div className="contact-links reveal">
            <a href="mailto:echang0970@gmail.com" className="contact-link">
              ...
              echang0970@gmail.com
            </a>
            <a
              href="https://github.com/ch4ngs4n1ty"
              target="_blank"
            ...
            >
              ...
              github.com/ch4ngs4n1ty
            </a>
            <a
              href="https://www.linkedin.com/in/echang0970"
              target="_blank"
              rel="noopener noreferrer"
              className="contact-link"
            >
